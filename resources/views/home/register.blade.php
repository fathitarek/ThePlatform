        ...
        <form class="login-form" action="{{ URL('register') }}" method="post">
         ...
         <div class="form-group {{ $errors->has('phone_number') ? ' has-error' : '' }}">
            ...
            <div class="form-group {{ $errors->has('password') ? ' has-error' : '' }}">
                ...
                <input class="form-control" name="password" placeholder="{{ Lang::get('home.enter').Lang::get('home.password') }}" type="password">
...
if you have account, please <a href="{{ URL('login') }}" class="signupclick">Login</a>
