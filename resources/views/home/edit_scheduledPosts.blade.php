            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                        ...
                        <textarea class="form-control" name="message" id="postMessage" placeholder="Post Content" rows="5" style="height: 50px; overflow: hidden; word-wrap: break-word;border: none;resize: none;" data-autosize-on="true">{{$data->message}}</textarea>
                    </div>
    ...
    <script>
        ...
        $(document).ready(function(){
            ...
            $(document).on('click','#useImage',function(){
                image_url=$("#resources-items .resource-item .active-resource img").attr('src');
                image_id=$("#resources-items .resource-item .active-resource img").data('id');
                $("#postPhoto").html('<div><button type="button" id="removePostPhoto" class="close">×</button><img data-id="'+image_id+'" src="'+image_url+'" style="width:120px;height:120px;" /></div>')
            ...
            $(document).on('click','#resources-items .resource-item img',function(){
                ...
                $(this).parent().addClass('active-resource')
            });
                            ...
                            if(page_type=='twitter'){
                                ...
                                if(Twitter.isLogin()){
                                    ...
                                    Twitter.makeTweet(message,picture_url,function(reply, rate, err){
                                        console.log(reply);
                                        post_id =(typeof picture_url=='undefined')? reply.id:reply.post_id;
