    ...
    <div class="auth-box-w">
        ...
        <form class="login-form" action="<?php echo e(URL('register')); ?>" method="post">
         ...
         <div class="form-group <?php echo e($errors->has('username') ? ' has-error' : ''); ?>">
                ...
                <input class="form-control" value="<?php echo e(old('username')); ?>" name="username" placeholder="Enter Username" >
            ...
            <div class="form-group <?php echo e($errors->has('email') ? ' has-error' : ''); ?>">
                ...
                <input class="form-control" value="<?php echo e(old('email')); ?>" name="email" placeholder="<?php echo e(Lang::get('home.enter').Lang::get('home.email')); ?>" type="email">
                <div class="pre-icon os-icon os-icon-user-male-circle"></div>
         ...
         <div class="form-group <?php echo e($errors->has('phone_number') ? ' has-error' : ''); ?>">
                ...
                <input class="form-control" value="<?php echo e(old('phone_number')); ?>" name="phone_number" placeholder="Enter phone" >
                <div class="pre-icon os-icon os-icon-user-male-circle"></div>
