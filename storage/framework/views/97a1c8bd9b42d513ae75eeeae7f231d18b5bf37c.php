    ...
    <div class="container">
        ...
        <div>
            ...
            <div _ngcontent-c25="" class="step choose-type">
                <div class="container">
                <?php echo Form::model($data,['method' =>'PATCH', 'action'=>['statusController@updateScheduledPosts',$data->id],'files' => true]); ?>
                ...
                <div class="row">
                    <div class='col-sm-6'>
                        <div class="form-group">
                            <label>Message</label>
                            <textarea rows="4" cols="50" name="message"> <?php echo e($data->message); ?></textarea>
                        </div></div></div>
                <div class="row">
                    <div class='col-sm-6'>
                        <div class="form-group">
                ...
                <div class="row">
                    <div class='col-sm-6' id="choose_time" style="display: none;">
                        <div class="form-group">
                            <input id="datetime" value="<?php echo e($data->created_time); ?>" type="datetime-local" name="created_time">
                    ...
                    <div class="row">
                        <div class='col-sm-6'>
                            <div class="form-group">
                                ...
                                <?php echo $data->picture ? '<div><img src="'.$data->picture.'" height="40"/></div>':''; ?>
