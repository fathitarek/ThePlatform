...
<?php $__env->startSection('contentHeader'); ?>
    ...
    <div class="page-bar">
        <ul class="page-breadcrumb">
            ...
            <li>
                <span><?php echo e(Lang::get('main.users')); ?></span>
            </li>
        </ul>
...
<?php $__env->startSection('content'); ?>
    ...
    <?php if(PerUser('users_add')): ?>
    <div class="row">
        <div class="col-md-12">
            <div class="btn-group pull-right">
                <a href="<?php echo e(URL('admin/users/create')); ?>" id="sample_editable_1_new" class="btn green"> Add New
            ...
            <div class="portlet-body">
                <table class="table table-striped table-bordered table-hover dt-responsive" width="100%" id="sample_1">
                    ...
                    <tr>
                        ...
                        <th class="all"><?php echo e(Lang::get('main.image')); ?></th>
                        <th class="none"><?php echo e(Lang::get('main.username')); ?></th>
                        <th class="none"><?php echo e(Lang::get('main.email')); ?></th>
                    ...
                    <?php $__currentLoopData = $users; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $post): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                        ...
                        <tr id="users-<?php echo e($post->id); ?>">
                            <td><?php echo e($x); ?></td>
                            <td><?php echo e($post->name); ?></td>
                            <td class="text-center"><img src="<?php echo e(asset($post->img_dir.$post->img)); ?>" alt=""></td>
                            <td><?php echo e($post->username); ?></td>
                            <td><?php echo e($post->email); ?></td>
                            <td class="text-center">
                                <div class="checkbox-nice checkbox-inline">
                                    <input data-id="<?php echo e($post->id); ?>" type="checkbox" <?php if(!PerUser('users_active')): ?> disabled="disabled" <?php endif; ?> class="<?php if(PerUser('users_active')): ?> changeStatues <?php endif; ?>" <?php if($post->active==1): ?> checked="checked" <?php endif; ?> id="checkbox-<?php echo e($post->id); ?>">
                            ...
                            <td>
                                <div class="btn-group pull-right">
                                    ...
                                    <ul class="dropdown-menu pull-right">
                                        <?php if(PerUser('users_edit')): ?>
                                        <li>
                                            <a href="<?php echo e(URL('admin/users/'.$post->id.'/edit')); ?>">
                                                <i class="fa fa-pencil"></i> <?php echo e(Lang::get('main.edit')); ?> </a>
                                        </li>
                                        <?php endif; ?>
                                        <?php if(PerUser('users_delete')): ?>
                                        <li>
        ...
        $(document).ready(function(){
            ...
            $(document).on('change','.changeStatues',function(){
                ...
                if(statues){
                    $.ajax({
                        type: "POST",
                        url: "<?php echo e(URL('admin/users/activation')); ?>",
            ...
            $(document).on('click','.delete_this',function(event){
                ...
                BootstrapDialog.show({
                    title: '<?php echo e(Lang::get('main.delete').lang::get('main.users')); ?>',
                    message: '<?php echo e(Lang::get('main.delete_this').lang::get('main.users')); ?> ?',
                    buttons: [
                        {
                            ...
                            action: function(dialogItself){
                                $.ajax({
                                    type: "DELETE",
                                    url: "<?php echo e(URL('admin/users')); ?>/"+deleted_id,
